...
namespace BreakInfinity
{
    ...
    public static class BigDoubleExtensions
    {
        ...
        public static string ToWords(this BigDouble value, int uptoDecimals)
        {
            string notation = "";

            string uptoPlaces = "N" + uptoDecimals;

            string mantissaString = (value.Mantissa).ToString(uptoPlaces);

            return notation = value.Exponent switch
            {
                0 => (value.Mantissa * Math.Pow(10, 0)).ToString(uptoPlaces),
                1 => (value.Mantissa * Math.Pow(10, 1)).ToString(uptoPlaces),
                2 => (value.Mantissa * Math.Pow(10, 2)).ToString(uptoPlaces),
                3 => (value.Mantissa * Math.Pow(10, 3)).ToString(uptoPlaces),
                long n when (n > 3 && n < 6) => (Math.Pow(10, n - 3) * value.Mantissa).ToString(uptoPlaces) + " Thousand",
                6 => mantissaString + " Million",
                long n when (n > 6 && n < 9) => (Math.Pow(10, n - 6) * value.Mantissa).ToString(uptoPlaces) + " Million",
                9 => mantissaString + " Billion",
                long n when (n > 9 && n < 12) => (Math.Pow(10, n - 9) * value.Mantissa).ToString(uptoPlaces) + " Billion",
                12 => mantissaString + " Trillion",
                long n when (n > 12 && n < 15) => (Math.Pow(10, n - 12) * value.Mantissa).ToString(uptoPlaces) + " Trillion",
                15 => mantissaString + " Quadrillion",
                long n when (n > 15 && n < 18) => (Math.Pow(10, n - 15) * value.Mantissa).ToString(uptoPlaces) + " Quadrillion",
                18 => mantissaString + " Quintillion",
                long n when (n > 18 && n < 21) => (Math.Pow(10, n - 18) * value.Mantissa).ToString(uptoPlaces) + " Quintillion",
                21 => mantissaString + " Sextillion",
                long n when (n > 21 && n < 24) => (Math.Pow(10, n - 21) * value.Mantissa).ToString(uptoPlaces) + " Sextillion",
                24 => mantissaString + " Septillion",
                long n when (n > 24 && n < 27) => (Math.Pow(10, n - 24) * value.Mantissa).ToString(uptoPlaces) + " Septillion",
                27 => mantissaString + " Octillion",
                long n when (n > 27 && n < 30) => (Math.Pow(10, n - 27) * value.Mantissa).ToString(uptoPlaces) + " Octillion",
                30 => mantissaString + " Nonillion",
                long n when (n > 30 && n < 33) => (Math.Pow(10, n - 30) * value.Mantissa).ToString(uptoPlaces) + " Nonillion",
                33 => mantissaString + " Decillion",
                long n when (n > 33 && n < 36) => (Math.Pow(10, n - 33) * value.Mantissa).ToString(uptoPlaces) + " Decillion",
                36 => mantissaString + " Undecillion",
                long n when (n > 36 && n < 39) => (Math.Pow(10, n - 36) * value.Mantissa).ToString(uptoPlaces) + " Undecillion",
                39 => mantissaString + " Duodecillion",
                long n when (n > 39 && n < 42) => (Math.Pow(10, n - 39) * value.Mantissa).ToString(uptoPlaces) + " Duodecillion",
                42 => mantissaString + " Tredecillion",
                long n when (n > 42 && n < 45) => (Math.Pow(10, n - 42) * value.Mantissa).ToString(uptoPlaces) + " Tredecillion",
                45 => mantissaString + " Quattuordecillion",
                long n when (n > 45 && n < 48) => (Math.Pow(10, n - 45) * value.Mantissa).ToString(uptoPlaces) + " Quattuordecillion",
                48 => mantissaString + " Quindecillion",
                long n when (n > 48 && n < 51) => (Math.Pow(10, n - 48) * value.Mantissa).ToString(uptoPlaces) + " Quindecillion",
                51 => mantissaString + " Sexdecillion",
                long n when (n > 51 && n < 54) => (Math.Pow(10, n - 51) * value.Mantissa).ToString(uptoPlaces) + " Sexdecillion",
                54 => mantissaString + " Septendecillion",
                long n when (n > 54 && n < 57) => (Math.Pow(10, n - 54) * value.Mantissa).ToString(uptoPlaces) + " Septendecillion",
                57 => mantissaString + " Octodecillion",
                long n when (n > 57 && n < 60) => (Math.Pow(10, n - 57) * value.Mantissa).ToString(uptoPlaces) + " Octodecillion",
                60 => mantissaString + " Novemdecillion",
                long n when (n > 60 && n < 63) => (Math.Pow(10, n - 60) * value.Mantissa).ToString(uptoPlaces) + " Novemdecillion",
                63 => mantissaString + " Vigintillion",
                long n when (n > 63 && n < 100) => (Math.Pow(10, n - 63) * value.Mantissa).ToString(uptoPlaces) + " Vigintillion",
                100 => mantissaString + " Googol",
                long n when (n > 100 && n < 303) => (Math.Pow(10, n - 100) * value.Mantissa).ToString(uptoPlaces) + " Googol",
                303 => mantissaString + " Centillion",
                long n when (n > 303) => (Math.Pow(10, n - 303) * value.Mantissa).ToString(uptoPlaces) + " Centillion",
                long n when (n < 0 && n > -10) => (value.ToDouble()).ToString(uptoPlaces),
                _ => mantissaString + " e" + value.Exponent,
            };
        }
